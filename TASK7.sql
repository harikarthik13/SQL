...
insert into employee values(101,'sharon',1,'java developer'),(102,'karthi',2,'php developer'),
...
eid int primary key,
ename varchar(20),
mid int default 100 foreign key references manager(manager_id)on delete cascade on update set default,
department varchar(20));
